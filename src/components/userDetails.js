...
class UserDetails extends React.Component{ 
    ...
    handleSubmit(evt) {
        ...
        // });
        axios.put(`${ROOT_URL}/users/${this.state.userData.id}`, formData)
    ...
    handleAddressChange(event) {
        let addressData = Object.assign({}, this.state.userData.address[0]);    //creating copy of object
        let field_name = event.target.name;
        addressData[field_name] = event.target.value;                        //updating value
        let {userData} = this.state;
        userData.address[0] = addressData;
        this.setState({userData});
    }
                                        ...
                                        <div className="row pv-lg">
                                            ...
                                            <div className="col-lg-8">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="col-sm-8">
                                                        <input id="birthDay" name="birthDay" placeholder="mm/dd" type="text"  value={user.birthMonth+"/"+user.birthDay || ''} onChange={this.handleChange.bind(this)} className="form-control"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="col-sm-8">
                                                        <textarea id="street" name="street" className="form-control" onChange={this.handleAddressChange.bind(this)}  value={user.street}></textarea>
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="apt" className="col-sm-4 control-label">Apt #</label>
                                                    <div className="col-sm-8">
                                                        <input id="apt" name="apt" type="text" value={user.apt || ''} onChange={this.handleAddressChange.bind(this)} className="form-control"/>
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="city" className="col-sm-4 control-label">City</label>
                                                    <div className="col-sm-8">
                                                        <input id="city" name="city" type="text" value={user.city || ''} onChange={this.handleAddressChange.bind(this)} className="form-control"/>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="col-sm-8">
                                                        <input id="state" name="address[0][state]" type="text" value={user.state || ''} onChange={this.handleChange.bind(this)} className="form-control"/>
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="zip" className="col-sm-4 control-label">Zip</label>
                                                    <div className="col-sm-8">
                                                        <input id="zip" name="zip" type="text" value={user.zip || ''} onChange={this.handleAddressChange.bind(this)} className="form-control"/>
                                                    </div>
                                                </div>
                                                <div className="form-group">

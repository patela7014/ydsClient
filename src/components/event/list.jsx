        ...
        return(
            <tr key={eventRow.id} >
                <td className="col-name">
                    <a href="#" onClick={()=>{this.open(eventRow.id)}} className="col-name">{eventRow.title}</a>
                </td>
                <td className="col-subject">
                    <a href="#" onClick={()=>{this.open(eventRow.id)}}>
                        <span className="label label-warning">Sabha</span>
                         &nbsp;{eventRow.description}
                    </a>
                </td>
                <td className="col-options"> 5
                    <a href="#" onClick={()=>{this.viewAttendance(eventRow.id)}}>See Attendance</a>
                </td>
